...
public class OtraPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Otra";
	...
	private OtraPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(basededatos.Media.class);
		aMetadataSources.addAnnotatedClass(basededatos.Video.class);
		aMetadataSources.addAnnotatedClass(basededatos.Imagen.class);
		aMetadataSources.addAnnotatedClass(basededatos.Usuario.class);
		aMetadataSources.addAnnotatedClass(basededatos.Moderador.class);
		aMetadataSources.addAnnotatedClass(basededatos.Administrador.class);
		aMetadataSources.addAnnotatedClass(basededatos.Tema.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new OtraPersistentManager();
		}
