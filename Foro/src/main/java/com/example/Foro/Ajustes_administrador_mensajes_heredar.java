...
public class Ajustes_administrador_mensajes_heredar extends Ajustes_administrador_mensajes_ventana implements View {
	Button ajustes,notificacion,cerrarsesion,usuariosreportados,amigos,perfil,cambiar,foro,usuariosbaneados,modificarmensajes;
	TextField numero;
	int numeroMensajes;
	Navigator navegador;
	public Ajustes_administrador_mensajes_heredar() {
	...
	public void inicio(int idusuario) {
		...
		numero=this.numeromensajes_html;
		try {
		numero.setValue(numeroMensajes+"");
		}catch(NullPointerException e) {
			numero.setValue("No definido");
		}
		cambiar.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				numeroMensajes=Integer.parseInt(numero.getValue());
				numero.setValue(numeroMensajes+"");
