...
public class Ajustes_usuario_amigos_heredar extends Ajustes_usuario_amigos_ventana implements View {
	Button ajustes,notificacion,cerrarsesion;
	VerticalLayout listaDeUsuarios;
	Navigator navegador;
	Button amigos,usuarios,perfil,foro;
	public Ajustes_usuario_amigos_heredar() {
	...
	public void inicio(int idusuario) {
		...
		this.usuarios_html.addClickListener(new Button.ClickListener() {
