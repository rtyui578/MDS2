...
public class Ajustes_administrador_lista_heredar extends Ajustes_administrador_lista_ventana implements View{
	...
	Navigator navegador;
	public Ajustes_administrador_lista_heredar() {
	...
	public void iniciar(int idusuario) {
		...
		foro.Usuario[] usuarios;
		try {
			usuarios = UsuarioDAO.listUsuarioByCriteria(new UsuarioCriteria());
