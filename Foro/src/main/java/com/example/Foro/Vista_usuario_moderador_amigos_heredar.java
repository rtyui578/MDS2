...
public class Vista_usuario_moderador_amigos_heredar extends Vista_usuario_moderador_amigos_ventana implements View {
	Button mensajes,amigos,listausuarios,perfil,foro,ajustes,notificaciones,cerrarsesion;
	Label nombreusuario;
	VerticalLayout listaamigos;
	Navigator navegador;
	public Vista_usuario_moderador_amigos_heredar() {
