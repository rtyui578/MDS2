...
public class Ajustes_moderador_lista_heredar extends Ajustes_moderador_lista_ventana implements View {
	Button ajustes,notificacion,cerrarsesion,usuariosreportados,amigos,perfil,listausuarios,foro;
	VerticalLayout listaDeUsuarios;
	Navigator navegador;
	public Ajustes_moderador_lista_heredar() {
	...
	public void inicio(int idusuario) {
		...
		listausuarios=this.listausuarios_html1;
		BD_Usuario bdusuario = new BD_Usuario();
		foro.Usuario[] usuarios=bdusuario.conseguirLista();
