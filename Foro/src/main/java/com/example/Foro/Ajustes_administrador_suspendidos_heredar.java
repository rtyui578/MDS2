...
public class Ajustes_administrador_suspendidos_heredar extends Ajustes_administrador_suspendidos_ventana implements View{
	Button ajustes,notificacion,cerrarsesion,usuariosreportados,amigos,perfil,mensajes,foro,usuariosbaneados,modificarmensajes;
	Label nombreusuario,email,contraseña;
	VerticalLayout listareportados;
	Navigator navegador;
	public Ajustes_administrador_suspendidos_heredar() {
	...
	public void iniciar(int idusuario) {
		...
		listareportados=this.listaususariosbaneados_html;
		BD_Usuario bd = new BD_Usuario();
		foro.Usuario[] usuarios = bd.usuariosBaneados();
