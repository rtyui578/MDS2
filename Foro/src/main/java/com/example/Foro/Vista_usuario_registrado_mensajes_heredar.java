...
public class Vista_usuario_registrado_mensajes_heredar extends Vista_usuario_registrado_mensajes_ventana implements View {
	Button mensajes,amigos,listausuarios,perfil,foro,ajustes,notificaciones,cerrarsesion;
	Label nombreusuario;
	VerticalLayout listacomentarios;
	Navigator navegador;
	public Vista_usuario_registrado_mensajes_heredar() {
