...
public class Vista_usuario_administrador_mensajes_heredar extends Vista_usuario_administrador_mensajes_ventana implements View {
	Button mensajes,amigos,listausuarios,perfil,foro,ajustes,notificaciones,cerrarsesion;
	Label nombreusuario;
	VerticalLayout listacomentarios;
	Navigator navegador;
	public Vista_usuario_administrador_mensajes_heredar() {
		
	}
	public void setNavegador(Navigator nav) {
		navegador=nav;
	}
	public void iniciar(int idusuario,int idUsuarioNavega) {
		foro=this.foro_html;
