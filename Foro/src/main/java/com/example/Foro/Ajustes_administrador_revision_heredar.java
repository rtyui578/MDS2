...
public class Ajustes_administrador_revision_heredar extends Ajustes_administrador_revision_ventana implements View{
	Button ajustes,notificacion,cerrarsesion,usuariosreportados,amigos,perfil,mensajes,modificarmensajes,usuariosbaneados,foro;
	Label nombreusuario,email,contraseña;
	VerticalLayout listareportados;
	Navigator navegador;
	public Ajustes_administrador_revision_heredar() {
	...
	public void iniciar(int idusuario) {
		...
		foro.Usuario[] usuarios = bd.usuariosReportados();
